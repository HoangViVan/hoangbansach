...
function shopping_cart_woocommerce_scripts() {
	...
	wp_add_inline_style( 'shopping-cart-woocommerce-style',$shopping_cart_woocommerce_tp_theme_css );
	wp_style_add_data('shopping-cart-woocommerce-style', 'rtl', 'replace');
...
if ( ! function_exists( 'shopping_cart_woocommerce_credit' ) ) {
	function shopping_cart_woocommerce_credit(){
		echo "<a href=".esc_url(SHOPPING_CART_WOOCOMMERCE_CREDIT)." target='_blank'>".esc_html__(get_theme_mod('shopping_cart_woocommerce_footer_text',__('Shopping Cart WordPress Theme','shopping-cart-woocommerce')))."</a>";
	}
}
