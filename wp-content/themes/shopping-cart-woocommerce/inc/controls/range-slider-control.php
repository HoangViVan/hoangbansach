 ...
 */
/** Range Control */
class Shopping_Cart_Woocommerce_Range_Slider extends WP_Customize_Control {
    /**
    ...
    public function enqueue() {
        wp_enqueue_style( 'shopping_cart_woocommerce-range-control-styles', get_parent_theme_file_uri( '/assets/css/controls/range.css' ), false, '1.0.0', 'all' );
        wp_enqueue_script( 'shopping_cart_woocommerce-range-control-scripts', get_parent_theme_file_uri( '/assets/js/controls/range.js' ), array( 'jquery' ), '1.0.0', true );
    }
    /**
