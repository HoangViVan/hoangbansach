				...
				<table>
					...
					<tbody>
						...
						<tr class="odd" scope="row">
							...
							<td class="feature feature--empty"></td>
							<td headers="comp-2" class="td-btn-2"><a class="sidebar-button single-btn" href="<?php echo esc_url(SHOPPING_CART_WOOCOMMERCE_PRO_THEME_URL);?>" target="_blank"><?php esc_html_e( 'Go for Premium', 'shopping-cart-woocommerce' ); ?></a></td>
						</tr>
					</tbody>
				</table>
			</div>
