...
<div class="container">
  <div class="headerbox">
    <div class="row">
      <div class="col-lg-6 col-md-12 align-self-center text-center text-md-left">
      ...
      <div class="col-lg-6 col-md-6 align-self-center text-center text-md-right">
        <?php if( get_theme_mod( 'shopping_cart_woocommerce_phone_number_text' ) != '') { ?>
          <p class="mb-0 phone-info"><span><i class="<?php echo esc_attr(get_theme_mod('shopping_cart_woocommerce_phone_icon','fas fa-phone')); ?> phone-info mr-2"></i></span><span class="no-text"><?php esc_html_e('Need help? Call us: ','shopping-cart-woocommerce'); ?></span><span class="phone-no"><?php echo esc_html( get_theme_mod('shopping_cart_woocommerce_phone_number_text','')); ?></span></p>
        <?php } ?>
      </div>
    </div>
  </div>
